 ...
 *     under the License.
 */
package ch.icclab.cyclops.usecases.openstack.impl;
 ...
 * Created on: 8-April-16
 * Description: Transform Openstack Event record to Usage Data Record entry
 */
public class OpenstackCollectorEventToUDR extends AbstractRunner {
    final static Logger logger = LogManager.getLogger(OpenstackCollectorEventToUDR.class.getName());
     ...
     */
    public OpenstackCollectorEventToUDR() {
    ...
    private void transformEventsToUDRs() {
        ...
        //Load all events
        String dbname = Loader.getSettings().getOpenstackCollectorSettings().getOpenstackCollectorDBEventsName();
