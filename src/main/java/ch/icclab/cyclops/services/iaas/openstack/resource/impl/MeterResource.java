...
public class MeterResource extends ServerResource implements UDRResource {
    ...
    public Representation setMeterList(Representation entity) {
        ...
        try {
            ...
            logger.error("Error while casting the JSON: "+e.getMessage());
        }
        ...
        try {
            ...
            logger.error("Error while saving the data: "+e.getMessage());
            output = false;
        }
        // Set the time stamp
        ...
        if (output) {
            ...
            logger.debug("Data could not be saved into the DB");
