...
import ch.icclab.cyclops.services.iaas.cloudstack.model.Response;
import ch.icclab.cyclops.services.iaas.cloudstack.util.GsonUtils;
...
public class CloudStackDownloader implements Callable {
     ...
     */
    protected List<Point> performRequest() {
        try {
